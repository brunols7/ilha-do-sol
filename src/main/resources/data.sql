...
('Admin', 'admin@gmail.com', '12345678900', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN', CURRENT_TIMESTAMP);

INSERT INTO hotel_info (nome, telefone, logradouro, bairro, cidade, uf, numero, cep) VALUES
('Hotel Ilha do Sol', '(1) 5682-7300', 'Av. Eng. Eusébio Stevaux', 'Santo Amaro', 'São Paulo', 'SP', '823', '04696-000');

INSERT INTO quartos (nome, descricao, numero_quarto, capacidade_max, camas, valor, image_url) VALUES
('Suíte Master', 'Suíte espaçosa com vista para o mar, banheira de hidromassagem, varanda privativa e decoração premium', '101', 4, 2, 450.00, 'https://images.unsplash.com/photo-1571456803038-80efbf5c9d6b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGhvdGVsJTIwcm9vbXMlMjB3aXRoJTIwYmF0aHxlbnwwfHwwfHx8MA%3D%3D'),
